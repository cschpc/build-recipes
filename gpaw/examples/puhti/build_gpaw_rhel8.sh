...
# bash examples/puhti/build_gpaw_rhel8.sh
...
modules=('gcc/11.3.0' 'openmpi/4.1.4' 'intel-oneapi-mkl/2022.1.0' 'fftw/3.3.10-mpi-omp')
module load ${modules[@]}
#version=$gpaw_version-gcc-openblas-elpa$openmp
version=$gpaw_version-gcc-mkl$openmp
...
spack_view=/appl/spack/v018/views/gpaw-python-env
...
then
  ...
  export GPAW_CONFIG=$main_dir/setup/siteconfig-puhti.py
else
